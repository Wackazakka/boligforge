        ...
        <div className="hero-inner">
          <div className="hero-head">
            ...
            <p className="hero-sub">
              ...
              Lim inn lenken fra Hjem eller Finn, motta ferdig film klar for Facebook, Instagram og LinkedIn.
            </p>
        ...
        <div className="wrap">
          ...
          <div className="steps">
            <div className="step">
              ...
              <p>Hjem eller Finn — vi henter bilder, pris, adresse og nøkkeldata automatisk. Ingen opplasting, bare en URL.</p>
            </div>
          ...
          <div className="faq-grid">
            ...
            <div>
              ...
              <details className="faq-item">
                ...
                <p>Ikke ennå — fagsystem-integrasjon står på veikartet. I dag henter ReelHome alt automatisk fra annonse-lenken (Hjem eller Finn): bilder, pris, adresse og nøkkeldata på sekunder.</p>
              </details>
            </div>
          </div>
        </div>
